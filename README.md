...
- watch:<br/>
    - A Smart Watch reference app demonstrating Bluetooth A2DP source, AVRCP Controller/Target, Apple Media Service (AMS) and Apple Notification Center Service (ANCS)
- audio_gateway:<br/>
    - Sample app demonstrating Bluetooth Audio Gatway profile
