...
static wiced_result_t            ams_client_send_track_info(uint8_t info_id, uint8_t *attribute, uint16_t attribute_len);
 ...
 */
wiced_result_t ams_client_send_track_info(uint8_t info_id, uint8_t *attribute, uint16_t attribute_len)
{
